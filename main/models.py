...
class FullStack(models.Model):
    fname = models.CharField(max_length=200, blank=False, default=None)
    femails = models.EmailField(max_length=200, blank=False, default=None)
    fphones = models.CharField(max_length=50, blank=False, default=None)
    passout = models.CharField(max_length=50, blank=False, default=None)
    city = models.CharField(max_length=50, blank=False, default=None)
    classes = models.CharField(max_length=50, blank=False, default=None)
    upcomingBatch = models.CharField(max_length=50, blank=False, default=None)
    comment = models.CharField(max_length=50, blank=False, default=None)
    date_full = models.DateTimeField(auto_now_add=True)

class DigitalMarket(models.Model):
    fname = models.CharField(max_length=200, blank=False, default=None)
    femails = models.EmailField(max_length=200, blank=False, default=None)
    fphones = models.CharField(max_length=50, blank=False, default=None)
    passout = models.CharField(max_length=50, blank=False, default=None)
